...
namespace AtomStore.Authorization
{
    public class BaseResourceAuthorizationHandlerAuthorization : AuthorizationHandler<OperationAuthorizationRequirement, string>
    {
        private readonly IRoleService _roleService;
        public BaseResourceAuthorizationHandlerAuthorization(IRoleService roleService)
        {
        ...
        protected override async Task HandleRequirementAsync(AuthorizationHandlerContext context, OperationAuthorizationRequirement requirement, string resource)
        {
            ...
            if (roles != null)
            {
                ...
                if (hasPermission || listRole.Contains(CommonConstants.AppRoles.AdminRole))
                {
